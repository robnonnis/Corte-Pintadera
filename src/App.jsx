...
function Storia({ go }) {
  ...
  return (
    <div style={s.app}>
      <PageHead title="La nostra storia" back={()=>go("home")} icon={<img src="https://res.cloudinary.com/dovpg47yh/image/upload/f_auto,q_auto,w_80/v1781182383/corte_pintadera_logo_clean_mqshm5.png" style={{width:32,height:32,objectFit:"contain",filter:"brightness(0) invert(0.3) sepia(1) saturate(2)"}} alt=""/>}/>
