  ...
  return (
    <div style={s.app}>
      ...
      <div style={s.content}>
        ...
        {/* 1. LE ORIGINI */}
        <div style={{fontSize:9,letterSpacing:"4px",textTransform:"uppercase",color:c.hazel,marginBottom:4}}>Le origini</div>
        <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:21,fontWeight:300,color:c.warm,marginBottom:12,lineHeight:1.25}}>La casa di <em style={{fontStyle:"italic",color:c.hazel}}>Antonio e Maddalena</em></div>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:10}}>Al centro di Uta, nel cuore del Campidano, si trovava una delle case più grandi del paese. Due piani, oltre 260 metri quadri, costruita in <strong>ladiri</strong> — i mattoni di argilla cruda e paglia impastata, la tecnica edilizia tradizionale che dà ai muri uno spessore e un calore che il cemento non ha mai saputo imitare. Attorno, un giardino a forma di U di quasi mille metri quadri.</p>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:10}}>Era la casa di <strong>Antonio Lecca</strong> e <strong>Maddalena Carboni</strong>, che qui hanno cresciuto i loro due figli e visto nascere quattro nipoti. Tra questi, <strong>Alessandro</strong> è quello che l'ha vissuta di più: l'infanzia trascorsa in quel cortile, i pranzi in famiglia, i profumi della cucina con il soffitto affrescato a fiori.</p>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:10}}>Al centro di tutto c'era <strong>Maddalena</strong>, conosciuta in tutto il paese come una cuoca straordinaria. Aveva un <strong>forno a legna</strong> tutto suo, dove ogni giorno sfornava pane e dolci che le sue mani sapevano rendere unici.</p>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:14}}>In un angolo del giardino, ancora oggi, c'è la sua <strong>pianta di limoni</strong>. Ha più di quarant'anni. Non avevamo il cuore di toccarla.</p>

        {/* PULL QUOTE */}
        <div style={{borderLeft:`3px solid ${c.hazel}`,paddingLeft:16,margin:"0 0 18px"}}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:15,fontStyle:"italic",color:c.warm,lineHeight:1.6}}>"I soffitti li hanno dipinti a mano negli anni '50 — fiori in cucina, geometrie dorate in camera. La pianta di limoni è ancora quella di allora. Non avevamo il cuore di toccare nulla."</div>
        </div>

        {/* FACT PILLS */}
        <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:22}}>
          {[{l:"Costruzione",v:"Muri in ladiri"},{l:"Superficie",v:"260 mq + giardino ~1.000 mq"},{l:"Famiglia",v:"2 figli, 4 nipoti"},{l:"Acquisto",v:"Alessandro e Roberta, 2022"}].map((f,i)=>(
        ...
        {/* 2. IL RESTAURO */}
        <div style={{fontSize:9,letterSpacing:"4px",textTransform:"uppercase",color:c.hazel,marginBottom:4}}>Il restauro</div>
        <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:21,fontWeight:300,color:c.warm,marginBottom:12,lineHeight:1.25}}>Rinnovare senza <em style={{fontStyle:"italic",color:c.hazel}}>cancellare nulla</em></div>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:10}}>Nel 2022 Alessandro e Roberta acquistano la proprietà con un'idea precisa: preservare tutto ciò che la rende unica e ricavarne un luogo capace di accogliere. Il primo appartamento — circa 50 metri quadri con veranda coperta e giardinetto privato — viene ristrutturato senza toccare l'anima dell'edificio.</p>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:20}}>I muri in ladiri sono rimasti. Gli affreschi anni '50 anche — i fiori rosa della cucina e le geometrie dorate della camera, dipinti da artigiani locali. Quello che è cambiato è il comfort: nuovi impianti, cucina attrezzata, bagno con colonna massaggio, fibra ottica, due climatizzatori Wi-Fi. Nei prossimi anni nasceranno altri due appartamenti e una sala eventi affacciata sul grande giardino.</p>

        <div style={{height:1,background:c.sand,margin:"0 0 20px"}}/>

        {/* 3. SA PINTADERA */}
        <div style={{background:`${c.hazel}12`,borderRadius:18,padding:"18px 16px",marginBottom:20}}>
          <div style={{fontSize:9,letterSpacing:"4px",textTransform:"uppercase",color:c.hazel,marginBottom:4}}>Il simbolo</div>
        ...
        <div style={{fontSize:9,letterSpacing:"4px",textTransform:"uppercase",color:c.hazel,marginBottom:4}}>Il nome</div>
        <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:21,fontWeight:300,color:c.warm,marginBottom:12,lineHeight:1.25}}>Perché abbiamo scelto <em style={{fontStyle:"italic",color:c.hazel}}>questo simbolo</em></div>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:10}}>Una casa costruita in ladiri, con affreschi dipinti a mano, in un paese del Campidano dove quattro generazioni hanno lasciato il loro segno — meritava un nome che portasse lo stesso peso.</p>
        <p style={{fontSize:13.5,color:"#3a2e22",lineHeight:1.75,marginBottom:20}}><strong>Corte Pintadera</strong> è il nome di questo posto. La corte è lo spazio condiviso attorno a cui tutto si organizza. La pintadera è il segno che lo distingue: antico, sardo, irripetibile.</p>

        {/* CHIUSURA */}
        <div style={{background:`linear-gradient(160deg, #5c3018 0%, #7a4428 100%)`,borderRadius:18,padding:"22px 20px",textAlign:"center"}}>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:20,fontWeight:300,color:"#faf7f2",lineHeight:1.4,marginBottom:8}}>Una casa con <em style={{fontStyle:"italic",color:"#CEAD85"}}>il suo segno nel mondo</em></div>
          <div style={{fontSize:12,color:"rgba(206,173,133,0.85)",lineHeight:1.7,fontFamily:"'Cormorant Garamond',Georgia,serif",fontStyle:"italic"}}>Muri in ladiri, soffitti dipinti a mano, un giardino che aspettava.<br/>Corte Pintadera porta tutto questo — e c'è ancora spazio per la tua storia.</div>
        </div>
